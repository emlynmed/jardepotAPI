            ...
            <div class="div-navbar row" style="height: 100px;">
                ...
                <div class="col-sm" style="padding: 0; line-height:30px;">
                    <div class="text-barra text-center" style="font-size: 22px;">
                        Morelos
                        <br>
                        <a href="tel:7773179652" style="font-size: 16px !important;">
                            777 317 9652
                        </a>
                        <br>
                ...
                <div class="row">
                    ...
                    {{--<div class="col-md-2 d-flex justify-content-between align-items-center">
                        ...
                        <a target="_blank" href="https://www.instagram.com/jardepot_mexico/">
                            <img src="{{asset(" assets/images/icons/instragram_40x40.png")}}" alt=""
                                style="width: 40px;">
                        </a>
                    ...
                    {{-- <div class="col-md-1" style="margin-top: 5px">
                        <button class="btn dropdown-toggle" style="text-align:center;color: #FFF" type="button"
                            id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <span style="color: #fff !important;cursor:pointer;font-size: 15px">
                                <i class="material-icons d-flex"
                                    style="color: #f68600;font-size: 24px !important;">perm_identity</i>
                                Mi club
                            </span>
                        </button>
                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-lg-left"
                            aria-labelledby="dropdownMenuButton" style="width: 300px">
                            <div class="dropdown-item">
                                <span style="font-size: 15px"></span><a href="{{url('cuenta/login')}}"
                                    class="text-muted">Iniciar sesión</a>
                            </div>
                        </div>
                    </div> --}}
                </div>
        ...
        <div class="container-xl">
            ...
            <div class="collapse navbar-collapse row" id="navbarsDesktopL">
                <div class="col-md-12 d-flex justify-content-between align-items-center">
                    ...
                    {{-- <ul
                        class="navbar-nav mr-auto col-md-8 d-flex flex-wrap justify-content-center align-items-center"
                        id="menu">--}}
                        <ul class="navbar-nav mr-auto col-md-12 d-flex flex-wrap justify-content-center align-items-center"
                            ...
                            <li class="nav-item dropdown mr-xl-4 ml-md-1 ml-xl-2 column-items ml-xxs-n1" id="prueba1"
                                ...
                                <ul class="{{count($categoria1['nivel2']) > 10 ? 'column-navbar':''}} dropdown-menu">
                                    ...
                                    @foreach($categoria1['nivel2'] as $categoria2)
                                    <li class="dropdown-item"><a class="text-left text-muted"
                                            title="{{$categoria2['name']}}"
                                            href="{{url($categoria2['href'])}}">{{$categoria2['name']}}</a></li>
                                    @endforeach
                                </ul>
                                @endif
                            </li>
                        ...
                        {{-- <a class="mr-2 btn-sm d-flex" href="{{route('sales')}}"><img
                                style="width: 100px;position: absolute;margin-left: -100px;margin-top: -15px"
                                src="{{asset('assets/images/ofertas/promocion.png')}}" title="Ofertas Jardepot"
                                alt="Ofertas Jardepot"></a>--}}
                        {{-- <a class="mr-2 btn-sm d-flex" href="{{route('sales')}}"
                            style="background-color: #f44336; color: white;"><i
                                class="material-icons iconMod">attach_money</i>¡OFERTAS!</a>
                        <a class="mr-2 btn-warning btn-sm d-flex" target="_blank"
                            href="https://wa.me/527226481040?text=Hola,%20me%20gustaría%20saber%20sobre%20sus%20refacciones"
                            style="text-decoration: none;" rel="noopener"><i
                                class="material-icons iconMod">settings</i>Refacciones</a>

                        {{-- BOTON DE NAVBAR--}}
                        {{--<div class="mr-2 bg-dark btn-sm d-flex position-relative" style="text-decoration: none;"
                            rel="noopener">
                            <button class="btn dropdown-toggle py-0 position-relative" style="color: #FFF" type="button"
                                id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true"
                                aria-expanded="false">
                                <span class="d-flex justify-content-center align-items-center position-relative"
                                    style="color: #fff !important;cursor:pointer;font-size: 15px">
                                    <i class="material-icons d-flex"
                                        style="color: #f68600;font-size: 22px !important;">shopping_cart</i>
                                ...
                                <div class="dropdown-item" id="option-dropdown-cart1">
                                    <div class="mt-1"
                                        ...
                                        <button class="btn btn-secondary btn-lg btn-circle"
                                            onclick="removeAllProducts()" data-toggle="tooltip" title="Borrar todo">
                                            <i class="material-icons">remove_shopping_cart</i>
                                        </button>
                                        <a class="btn btn-warning btn- btn-circle" href="{{url('cart')}}"
                                            data-toggle="tooltip" title="Pagar">
...
{{--<nav class="navbar navbar-light bg-light  d-block d-sm-block d-lg-none">
    <div class="row">
        <div class="col-6">
            <a class="mr-2 btn-success btn-sm d-flex" target="_blank"
                href="https://wa.me/525551857805?text=Hola,%20me%20gustaría%20saber%20" style="text-decoration: none;"
                rel="noopener">
                    ...
                    <div class="row">
                        <div style="padding: 0;" class="col-12 col-md-3">
                            <div style="margin-bottom: 20px;">
                                ...
                                <a href="tel:8002129225" class="telModal"><span class="my-4"
                                        style="font-size: 20px; font-weight: 500;"><i class="material-icons">call</i>800
                                        212 9225</span></a>
                            </div>
                            <div style="margin-bottom: 20px;">
                                <p style="margin-bottom: 0px; font-size: 20px">Mayoreo</p>
                                <a href="tel:5544598506" class="telModal"><span class="my-4"
                                        style="font-size: 20px; font-weight: 500;"><i class="material-icons">call</i>55
                                        4459 8506</span></a>
                            </div>
                            <div style="margin-bottom: 20px;">
                                <p style="margin-bottom: 0px; font-size: 20px">Refacciones</p>
                                <a href="tel:7226481040" class="telModal"><span class="my-4"
                                        style="font-size: 20px; font-weight: 500;"><i class="material-icons">call</i>722
                                        648 1040</span></a>
                            </div>
                        </div>
                        <div style="padding: 0;" class="col-12 col-md-2">
                            <div style="margin-bottom: 20px;">
                                <p>CDMX</p>
                                <a href="tel:5549968849" class="telModal"><span class="my-4"
                                        style="font-size: 15px; font-weight: 300;"><i class="material-icons">call</i>55
                                        4996 8849</span></a><br>
                                <a href="tel:5549974360" class="telModal"><span class="my-4"
                                        style="font-size: 15px; font-weight: 300;"><i class="material-icons">call</i>55
                                        4997 4360</span></a><br>
                                <a href="tel:5551857805" class="telModal"><span class="my-4"
                                        style="font-size: 15px; font-weight: 300;"><i class="material-icons">call</i>55
                                        5185 7805</span></a><br>
                            </div>
                            <div style="margin-bottom: 20px;">
                                <p style="margin-bottom: 0px;">Querétaro</p>
                                <a href="tel:4423960365" class="telModal"><span class="my-4"
                                        style="font-size: 15px; font-weight: 300;"><i class="material-icons">call</i>442
                                        396 0365</span></a><br>
                                <a href="tel:4421239272" class="telModal"><span class="my-4"
                                        style="font-size: 15px; font-weight: 300;"><i class="material-icons">call</i>442
                                        123 9272</span></a><br>
                            </div>
                        </div>
                        <div style="padding: 0;" class="col-12 col-md-2">
                            <div style="margin-bottom: 20px;">
                                ...
                                <a href="tel:3317283353" class="telModal"><span class="my-4"
                                        style="font-size: 15px; font-weight: 300;"><i class="material-icons">call</i>33
                                        1728 3353</span></a><br>
                            </div>
                            <div style="margin-bottom: 20px;">
                                <p>Morelos</p>
                                <a href="tel:7773179630" class="telModal"><span
                                        style="font-size: 15px; font-weight: 300;"><i class="material-icons">call</i>777
                                        317 9630</span></a><br>
                                <a href="tel:7773179652" class="telModal"><span class="my-4"
                                        style="font-size: 15px; font-weight: 300;"><i class="material-icons">call</i>777
                                        317 9652</span></a><br>
                                <a href="tel:7773645067" class="telModal"><span class="my-4"
                                        style="font-size: 15px; font-weight: 300;"><i class="material-icons">call</i>777
                                        364 5067</span></a><br>
                                <a href="tel:7773645635" class="telModal"><span class="my-4"
                                        style="font-size: 15px; font-weight: 300;"><i class="material-icons">call</i>777
                                        364 5635</span></a><br>
                            </div>
                        </div>
                        <div style="padding: 0;" class="col-12 col-md-2">
                            <div style="margin-bottom: 20px;">
                                ...
                                <a href="tel:8120635708" class="telModal"><span class="my-4"
                                        style="font-size: 15px; font-weight: 300;"><i class="material-icons">call</i>81
                                        2063 5708</span></a><br>
                                <a href="tel:8111135702" class="telModal"><span class="my-4"
                                        style="font-size: 15px; font-weight: 300;"><i class="material-icons">call</i>81
                                        1113 5702</span></a><br>
                            </div>
                            <div style="margin-bottom: 20px;">
                                ...
                                <a href="tel:7226481040" class="telModal"><span class="my-4"
                                        style="font-size: 15px; font-weight: 300;"><i class="material-icons">call</i>722
                                        648 1040</span></a><br>
                            </div>
                            <div style="margin-bottom: 20px;">
                                <p style="margin-bottom: 0px;">Michoacán</p>
                                <a href="tel:4433560484" class="telModal"><span class="my-4"
                                        style="font-size: 15px; font-weight: 300;"><i class="material-icons">call</i>443
                                        356 0484</span></a><br>
                            </div>
                        </div>
                        <div style="padding: 0;" class="col-12 col-md-2">
                            <div style="margin-bottom: 20px;">
                                ...
                                <a href="tel:2227051726" class="telModal"><span class="my-4"
                                        style="font-size: 15px; font-weight: 300;"><i class="material-icons">call</i>222
                                        705 1726</span></a><br>
                            </div>
                            <div style="margin-bottom: 20px;">
                                <p style="margin-bottom: 0px;">Veracruz</p>
                                <a href="tel:2293300992" class="telModal"><span class="my-4"
                                        style="font-size: 15px; font-weight: 300;"><i class="material-icons">call</i>229
                                        330 0992</span></a><br>
                            </div>
                        </div>
                    </div>
                ...
                <div class="modal-body">
                    <div class="container">
                        <div style="padding: 0;" class="row">
                            <div class="col-md-12">
                                <a class="telModal" href="tel:5544598506"><i class="material-icons">call</i> 55 4459
                                    8506</a>
                            </div>
                        </div>
                        <hr>
