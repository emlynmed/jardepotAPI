        ...
        <div class="col-xl-10 col-lg-11 my-4" style="display: flex; flex-wrap: wrap; max-width: 1300px;">
            ...
            <div class="col-md-2">
                ...
                <div style="margin-bottom: 20px;">
                    ...
                    <a href="tel:9982940670" style="color: #fff;"><span class="my-4" style="font-size: 15px; font-weight: 300;">998 294 0670</span></a><br>
                </div>
            </div>
            <div class="col-md-2">
                <div style="margin-bottom: 20px;">
        ...
        <div class="col-xl-9 col-lg-11 my-4" style="max-width: 1300px;">
            <div class="row">
                <div class="col-lg-4 col-xl-3" style="display: flex; justify-content: space-around;">
                        <a data-toggle="" style="color: #fff; text-decoration: underline;" href="{{url('aviso-privacidad')}}">Aviso de Privacidad&nbsp;</a>
                        &nbsp;|&nbsp;&nbsp;
                        <a data-toggle=""  style="color: #fff; text-decoration: underline;" href="{{url('aviso-legal')}}">Aviso Legal</a>
                </div>
